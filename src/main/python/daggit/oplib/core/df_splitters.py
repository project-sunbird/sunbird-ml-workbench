...
from src.main.python.daggit.iolib.io import Pandas_Dataframe
from src.main.python.daggit.core.base import BaseOperator
...
class k_fold_splitter(BaseOperator):
    ...
    def run(self, drop_missing_perc, target_variable, ignore_variables, categorical_impute, numeric_impute):
        ...
        for train_index, test_index in kf.split(input_df):
            data_train, data_test = input_df.iloc[train_index], input_df.iloc[test_index]
